                    ...
                    if (patients != null) {
                        ...
                        for (var r = 0; r < patients.length; r++) {
                            ...
                            if (r > 0) {
                                ...
                                var row = "<div class=\"form-row\"> <div class=\"form-group col-md-4\"> <label for=\"fullname\">Full Name : </label> <label id=\"\">" + patients[r].Name + "</label> </div> <div class=\"form-group col-md-4\"> <label for=\"dob\">Date Of Birth : </label> <label id=\"\">" + patients[r].DateOfBirthStr + "</label> </div> </div><div class=\"form-row\"> <div class=\"form-group col-md-4\"> <label for=\"fullname\">Gender : </label> <label id=\"\">" + patients[r].GenderDescription + "</label> </div> <div class=\"form-group col-md-4\"> <label for=\"fullname\">Id Number : </label> <label id=\"\">" + patients[r].IdNumber + "</label> </div> </div>";
